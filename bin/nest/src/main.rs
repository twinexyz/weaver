...
// use tokio;
// use twine_sequencer::block_progress::block_progress::BlockProducer;
...
//             .unwrap();
//     let fee_recepient = Address::ZERO;
//     let block_time = 2000;

//     let mut block_producer = BlockProducer::new(
//         head_block,
//         "/Users/swopnilparajuli/workspace/work/weaver/jwt.hex".to_string(),
